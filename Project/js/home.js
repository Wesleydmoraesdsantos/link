...
function headandheart() {
 ...
 var camih = './capash/';
 var imgh = ['cover.jpg','cover (1).jpg','cover (2).jpg','hen.webp','cover (3).jpg','cover (4).jpg','hh.jpg','hh1.jpg','hh2.jpg','hh3.jpg','hh4.jpg','hh5.jpg','hh6.jpg','hh7.jpg','hh8.jpg'];
  ...
  var divppp = [];
  for(let i in imgh){
  divhen.push(window.document.createElement('div'));
  divhen[i].setAttribute('class','linem');
  divaa.push(window.document.createElement('a'));
  divaa[i].setAttribute('href',linkh[i]);
  divaa[i].setAttribute('target','_blank');
  divaa[i].setAttribute('relet','nofollow');
  diviii.push(window.document.createElement('img'));
  let imagemh = camih + imgh[i];
  diviii[i].setAttribute('src', imagemh);
  diviii[i].setAttribute('alt','capa do hen...');
  diviii[i].setAttribute('class','imgclass');
  divppp.push(window.document.createElement('p'));
  divppp[i].setAttribute('class','csstxt');
  divppp[i].appendChild(window.document.createTextNode(nameh[i]));
  
  divaa[i].appendChild(diviii[i]);
  divhen[i].appendChild(divaa[i]);
  divhen[i].appendChild(divppp[i]);
  classdiv.appendChild(divhen[i]);
  };
  classd[1].setAttribute('onclick','redirect(2)');
  classd[1].setAttribute('class','ordemnow');
  };
...
// lugarposter.style.backgroundRepeat="no-repeat"
 ...
 lugarposter.style.border="6px solid black";
 ...
 function Capa1(z) {
   ...
   //maincpx.setAttribute('onclick','redirect(1)');
 ...
 //testando o main menu
   ...
   var sell = [['Favorites','Anime list','Class','Search','Downloads','Coming soon','Settings','Home'],['soon','soon','searclass()','search()','soon','soon','soon','redirect(10)','redirect(9)'],['favorite.png','playmenu.png','classmenu.png','whitesearch.png','download.png','moon.png',`tools.png`,'homeimg.png']];
   var menul = null;
